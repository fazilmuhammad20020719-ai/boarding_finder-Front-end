    ...
    <div className="min-h-screen bg-black font-sans antialiased text-white flex flex-col">
      ...
      <main className="flex-grow pt-16 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 mb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FACC15]/10 text-[#FACC15] text-xs font-bold mb-6 border border-[#FACC15]/20">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-6 max-w-3xl mx-auto leading-tight">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div className="rounded-3xl overflow-hidden shadow-lg border border-[#333] relative h-[450px]">
            <img 
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-extrabold text-white mb-3">The Problem</h2>
            ...
            <div>
              <h2 className="text-2xl font-extrabold text-[#FACC15] mb-3">Our Solution</h2>
              <p className="text-white/70 font-medium leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-[#333]">
              <div>
                <div className="text-3xl font-black text-white mb-1">5,000+</div>
                <div className="text-sm font-bold text-white/50">Students Helped</div>
              </div>
              <div>
                <div className="text-3xl font-black text-white mb-1">1,200+</div>
                <div className="text-sm font-bold text-white/50">Verified Listings</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-[#111] border border-[#333] rounded-[2rem] p-10 md:p-14 text-center relative overflow-hidden shadow-xl">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#FACC15]/10 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-[#FACC15]/10 rounded-full blur-3xl pointer-events-none"></div>
            
            <h2 className="text-3xl font-extrabold text-white mb-4 relative z-10">Ready to find your next home?</h2>
            <p className="text-white/70 font-medium mb-8 max-w-xl mx-auto relative z-10 text-lg">
              Join thousands of students who have already found their perfect boarding house through BoardingFinder.
            </p>
            <a href="/search" className="inline-block bg-[#FACC15] text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-[#EAB308] hover:scale-105 transition-all shadow-md relative z-10">
              Start Searching
            </a>
          </div>
        </section>
