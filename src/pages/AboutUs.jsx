      ...
      <main className="flex-grow pt-16 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div className="rounded-3xl overflow-hidden shadow-lg border border-[#e2e8f0]/60 relative h-[450px]">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <div className="text-slate-800 text-2xl font-bold mb-2">Built by students, for students.</div>
              <div className="text-slate-800/80 font-medium">We understand the struggle because we lived it.</div>
            </div>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-[#1952c4] rounded-[2rem] p-10 md:p-14 text-center relative overflow-hidden shadow-xl">
            ...
            <h2 className="text-3xl font-extrabold text-slate-800 mb-4 relative z-10">Ready to find your next home?</h2>
            <p className="text-slate-800/80 font-medium mb-8 max-w-xl mx-auto relative z-10 text-lg">
