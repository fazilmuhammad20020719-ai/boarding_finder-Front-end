...
const OwnerListingForm = () => {
          ...
          <div key={step} className="flex flex-col items-center relative z-10 w-full">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 ${currentStep === step
                ? 'bg-[#1952c4] text-slate-800 shadow-md shadow-[#1952c4]/30 ring-4 ring-[#ebf3ff]'
                : currentStep > step
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f9] font-sans antialiased text-[#0f172a] pb-20">
      {/* Top Bar */}
      <header className="bg-[#1e3a8a] text-slate-800 px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="text-xs font-semibold text-slate-800/70 uppercase tracking-wide">Owner Dashboard</div>
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-8 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-[#e2e8f0]/60 p-6 sm:p-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mb-4">
                    ...
                    <div className="flex-1 flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-slate-800 text-slate-800 font-bold text-sm rounded-xl hover:bg-slate-700 transition-colors"
                      >
                        Search
                      </button>
                    </div>
                    ...
                    {formData.photos.map((src, idx) => (
                      <div key={idx} className="relative aspect-square rounded-xl overflow-hidden shadow-sm group">
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 w-6 h-6 bg-black/50 hover:bg-red-500 text-slate-800 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all border-none cursor-pointer"
                        >
          ...
          {uploadStatus === 'uploading' && (
            <div className="mt-4 p-4 rounded-xl bg-slate-50 text-blue-700 text-sm font-semibold border border-blue-200 flex items-center gap-3">
          ...
          <div className="flex items-center justify-between mt-10 pt-6 border-t border-[#e2e8f0]">
            ...
            {currentStep < totalSteps ? (
              <button
                type="button"
                onClick={nextStep}
                className="px-8 py-3 rounded-xl font-bold text-sm bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 transition-colors border-none cursor-pointer shadow-sm flex items-center gap-2"
              >
                Next Step
              ...
              <button
                ...
                className="px-8 py-3 rounded-xl font-bold text-sm bg-[#10b981] hover:bg-[#059669] text-slate-800 transition-colors border-none cursor-pointer shadow-sm flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
