...
const PROMOTE_PLANS = [
  {
    ...
    color: 'bg-slate-50 border-blue-200 hover:border-blue-500',
    badge: null
  },
  {
    id: 'premium',
    ...
    color: 'bg-primary-50 border-purple-200 hover:border-purple-500',
    badge: 'Most Popular'
  },
  {
    id: 'ultimate',
          ...
          <div className="w-full lg:w-3/5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {PROMOTE_PLANS.map(plan => (
                ...
                >
                  {plan.badge && (
                    <div className="absolute -top-3 right-6 bg-[#1952c4] text-slate-800 text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full shadow-sm">
                      {plan.badge}
                    </div>
                  )}
               ...
               <form onSubmit={handlePayment} className="space-y-4">
                  ...
                  <div className="pt-4">
                    <button 
                      ...
                      className="w-full py-4 bg-[#0f172a] hover:bg-black disabled:bg-slate-400 disabled:cursor-not-allowed text-slate-800 font-bold rounded-xl shadow-md transition-all text-sm flex items-center justify-center gap-2"
                    >
                      {isProcessing ? (
                        <>
