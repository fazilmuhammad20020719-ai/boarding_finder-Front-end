...
const AdminDashboard = () => {
            ...
            <div className="bg-white p-5 rounded-2xl shadow-sm flex flex-col justify-between">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button 
                  ...
                  className="flex-1 bg-[#10b981] hover:bg-[#059669] text-slate-800 font-bold py-3 rounded-xl transition-colors disabled:opacity-50 border-none cursor-pointer"
                >
                  Approve
                </button>
              </div>
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f9] font-sans antialiased text-[#0f172a]">
      {/* Top Bar */}
      <header className="bg-[#1e293b] text-slate-800 px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xl font-extrabold text-slate-800">BoardingFinder Admin</div>
          </div>
        </div>
        ...
        <div className="flex border-b border-[#e2e8f0] mb-8 overflow-x-auto">
          ...
          >
            ...
            {stats?.pending_verifications > 0 && (
              <span className="bg-red-500 text-slate-800 text-[10px] px-2 py-0.5 rounded-full ml-1">{stats.pending_verifications}</span>
            )}
          </button>
                      ...
                      <tr key={user.id} className="border-b border-[#e2e8f0]/60 hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-5">
                          <button 
                            ...
                            className="bg-slate-800 hover:bg-slate-700 text-slate-800 font-bold py-2 px-4 rounded-xl text-xs transition-colors border-none cursor-pointer shadow-sm"
                          >
                            Review Docs
                          </button>
                        </td>
                   ...
                   {[
                     ...
                     <div key={index} className="flex flex-col items-center gap-3 z-10 flex-1 px-1">
                       <div className={`w-full max-w-[60px] bg-gradient-to-t ${bar.color} rounded-t-lg ${bar.h} relative group cursor-pointer`}>
                         <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-800 text-slate-800 text-xs font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                           {bar.val}
                         </div>
                       </div>
