...
const OwnerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f9] font-sans antialiased text-[#0f172a]">
      {/* Top Bar */}
      <header className="bg-[#1e3a8a] text-slate-800 px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-md">
        <div className="flex items-center gap-4 w-1/4">
          ...
          <div>
            <div className="text-[10px] font-bold text-slate-800/70 uppercase tracking-wider">Owner Dashboard</div>
        ...
        <div className="hidden lg:flex items-center gap-2 justify-center flex-1">
          <button
            ...
            className={`px-5 py-2.5 font-bold cursor-pointer flex items-center gap-2 rounded-xl transition-all border-none ${activeTab === 'overview' ? 'bg-white text-[#1e3a8a] shadow-sm' : 'bg-transparent text-slate-800/70 hover:text-slate-800 hover:bg-white/10'}`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 font-bold cursor-pointer flex items-center gap-2 rounded-xl transition-all border-none ${activeTab === 'listings' ? 'bg-white text-[#1e3a8a] shadow-sm' : 'bg-transparent text-slate-800/70 hover:text-slate-800 hover:bg-white/10'}`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 font-bold cursor-pointer flex items-center gap-2 rounded-xl transition-all border-none ${activeTab === 'bookings' ? 'bg-white text-[#1e3a8a] shadow-sm' : 'bg-transparent text-slate-800/70 hover:text-slate-800 hover:bg-white/10'}`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 font-bold cursor-pointer flex items-center gap-2 rounded-xl transition-all border-none ${activeTab === 'messages' ? 'bg-white text-[#1e3a8a] shadow-sm' : 'bg-transparent text-slate-800/70 hover:text-slate-800 hover:bg-white/10'}`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 font-bold cursor-pointer flex items-center gap-2 rounded-xl transition-all border-none ${activeTab === 'students' ? 'bg-white text-[#1e3a8a] shadow-sm' : 'bg-transparent text-slate-800/70 hover:text-slate-800 hover:bg-white/10'}`}
          >
        ...
        <div className="flex items-center justify-end w-1/4">
          <button onClick={handleLogout} className="flex items-center gap-2 text-slate-800/90 hover:text-slate-800 font-semibold transition-colors cursor-pointer bg-transparent border-none">
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-[24px] p-12 text-center border border-[#e2e8f0]/60 shadow-sm">
                ...
                <button
                  ...
                  className="bg-[#1952c4] text-slate-800 px-6 py-2.5 rounded-full font-bold text-sm hover:bg-[#1546a8] transition-colors border-none cursor-pointer"
                >
                        ...
                        <td className="px-6 py-5">
                          {booking.status === 'pending' ? (
                            <div className="flex gap-2">
                              <button onClick={() => handleUpdateBookingStatus(booking.booking_id, 'approved')} className="bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 px-4 py-1.5 rounded-full text-[13px] font-bold transition-colors cursor-pointer border-none shadow-sm">Approve</button>
                    ...
                    >
                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <div className="flex justify-between items-center gap-2">
                          ...
                          {conv.unread > 0 && (
                            <div className="w-5 h-5 rounded-full bg-[#1952c4] text-slate-800 text-[10px] font-bold flex items-center justify-center flex-shrink-0">
                              {conv.unread}
                            </div>
                          )}
                        </div>
                            ...
                            <div className={`max-w-[75%] sm:max-w-[60%] flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                              <div
                                className={`px-4 py-2.5 rounded-2xl text-[14px] leading-relaxed shadow-sm ${isMe
                                  ? 'bg-[#1952c4] text-slate-800 rounded-br-none'
                    ...
                    <form onSubmit={handleSendMessage} className="flex items-end gap-3">
                      ...
                      <button
                        ...
                        className={`p-3 rounded-2xl flex items-center justify-center transition-all flex-shrink-0 border-none ${newMessage.trim()
                          ? 'bg-[#1952c4] text-slate-800 shadow-md hover:bg-[#1546a8] cursor-pointer'
