    ...
    <div className="min-h-screen bg-[#f4f7f9] font-sans antialiased text-[#0f172a]">
      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          {/* Payout Method */}
          <div className="bg-[#1e3a8a] text-slate-800 p-6 rounded-[24px] shadow-sm flex flex-col justify-between relative overflow-hidden">
            <div className="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-white opacity-5 rounded-full blur-2xl"></div>
            <div className="flex items-center justify-between mb-4 relative z-10">
              <span className="text-slate-800/80 font-semibold text-sm uppercase tracking-wider">Payout Method</span>
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-800/70">Primary Account</p>
                </div>
              </div>
              <button className="mt-4 text-sm font-semibold text-slate-800/90 hover:text-slate-800 underline decoration-white/30 hover:decoration-white transition-all">
                Update Method
              </button>
            </div>
          </div>
