            ...
            {!submitted ? (
              <>
                ...
                <form onSubmit={handleReset} className="w-full">
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 mt-6 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-semibold rounded-[16px] transition-colors text-base shadow-sm"
                  >
                    Reset Password
                  </button>
                </form>
              ...
              <>
                ...
                <Link to="/login" className="w-full mb-4">
                  <button
                    type="button"
                    className="w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-[16px] flex items-center justify-center gap-2 text-[15px] transition-all duration-200 shadow-sm"
                  >
                    Continue to Login
                  </button>
                </Link>
