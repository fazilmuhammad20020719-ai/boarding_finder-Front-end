              ...
              {!isEditing ? (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className={`px-4 py-2 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold text-xs rounded-xl transition-all cursor-pointer border-none flex items-center gap-2 ${isSaving ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
                    {isSaving ? (
                      <>
                        <svg className="animate-spin h-3.5 w-3.5 text-slate-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
