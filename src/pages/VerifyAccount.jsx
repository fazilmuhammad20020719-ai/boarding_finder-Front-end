              ...
              <>
                ...
                <form onSubmit={handleVerify} className="w-full flex flex-col items-center">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-semibold rounded-[16px] transition-colors text-base shadow-sm mb-6 ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
