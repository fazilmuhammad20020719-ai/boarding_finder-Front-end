        ...
        <div className="w-full max-w-[520px]">
          <div className="bg-white rounded-[32px] p-8 sm:p-10 shadow-sm border border-[#e2e8f0]/60 flex flex-col items-center">
                ...
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                    step.done
                      ...
                      : step.active
                      ? 'bg-[#f59e0b] text-slate-800 animate-pulse'
            ...
            <button
              ...
              className={`w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-[16px] flex items-center justify-center gap-2 text-[15px] transition-all shadow-sm border-none ${
