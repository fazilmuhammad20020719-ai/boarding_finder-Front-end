      ...
      <main className="flex-grow pt-16 pb-24 max-w-7xl mx-auto px-6 md:px-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[#1e293b] rounded-3xl p-8 text-slate-800 relative overflow-hidden">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-[#e2e8f0]/60">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button 
                  type="submit" 
                  className="w-full bg-[#1952c4] text-slate-800 py-4 rounded-xl font-bold text-[15px] hover:bg-[#1546a8] transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer border-none flex items-center justify-center gap-2"
                >
