        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-slate-800/70 text-xs font-bold uppercase tracking-wider">Booking Reference</div>
                <div className="text-slate-800 text-xl font-black tracking-wide">{bookingRef}</div>
              </div>
            </div>
            <div className="text-right">
              <div className="text-slate-800/70 text-xs font-bold uppercase tracking-wider">Status</div>
              <div className="inline-flex items-center gap-1.5 bg-white/15 px-3 py-1.5 rounded-full mt-1">
                <div className="w-2 h-2 rounded-full bg-[#fbbf24] animate-pulse" />
                <span className="text-slate-800 font-bold text-sm">Pending Review</span>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors cursor-pointer border-none flex items-center justify-center gap-2 text-[14px] shadow-sm"
