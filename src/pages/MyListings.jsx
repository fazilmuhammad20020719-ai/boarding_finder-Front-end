      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-white/60 mt-1 text-[15px]">Manage your boarding houses and properties.</p>
          </div>
          <button
            onClick={() => navigate('/add-listing')}
            className="flex items-center gap-2 bg-[#FACC15] hover:bg-[#EAB308] text-black px-5 py-2.5 rounded-full font-bold text-sm transition-colors cursor-pointer border-none shadow-sm"
          >
        ...
        {error && (
          <div className="bg-red-500/20 text-red-500 border border-red-500/30 p-4 rounded-xl mb-6 font-medium">
            {error}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="bg-[#1A1A1A] rounded-[24px] p-12 text-center border border-[#333] shadow-sm">
            <div className="w-16 h-16 bg-[#111] text-[#FACC15] rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <>
            <div
              onClick={() => navigate('/add-listing')}
              className="w-full mb-8 bg-transparent rounded-3xl border-2 border-dashed border-[#333] hover:border-[#FACC15] hover:bg-[#111] transition-all cursor-pointer py-8 flex flex-col items-center justify-center gap-3 group"
            >
              <div className="w-14 h-14 rounded-full bg-[#222] text-white/40 group-hover:text-[#FACC15] flex items-center justify-center transition-colors shadow-sm">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto grid grid-cols-3 gap-3">
                      <button
                        ...
                        className="py-2.5 flex items-center justify-center gap-2 text-sm font-bold text-[#10b981] bg-[#111] border border-[#333] rounded-xl hover:bg-[#222] transition-colors cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="py-2.5 flex items-center justify-center gap-2 text-sm font-bold text-red-500 bg-[#111] border border-[#333] rounded-xl hover:bg-red-500/10 transition-colors cursor-pointer"
                      >
