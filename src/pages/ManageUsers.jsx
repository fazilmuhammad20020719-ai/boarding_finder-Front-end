      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <Link to="/admin-dashboard">
            <button className="px-5 py-2.5 bg-[#1e293b] hover:bg-[#0f172a] text-slate-800 font-semibold rounded-xl shadow-sm transition-all text-sm">
              Admin Dashboard
            </button>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-[24px] shadow-sm border border-[#e2e8f0]/60 overflow-hidden">
                    ...
                    <tr key={user.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold ${
                          user.role === 'Owner' ? 'bg-primary-100 text-purple-700' : 'bg-slate-100 text-blue-700'
                        }`}>
                          {user.role}
                        </span>
                      </td>
          ...
          <div className="px-6 py-4 border-t border-[#e2e8f0]/60 flex justify-between items-center text-sm">
            ...
            <div className="flex gap-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#1952c4] text-slate-800 font-semibold">1</button>
