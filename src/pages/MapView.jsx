              ...
              >
                <button
                  ...
                  className={`px-3.5 py-2 rounded-full font-bold text-[13px] shadow-lg border-2 flex items-center gap-1 transition-all duration-200 cursor-pointer ${
                    isSelected
                      ? 'bg-[#1952c4] border-[#1952c4] text-slate-800 ring-4 ring-[#1952c4]/20'
                      : isHovered
                      ? 'bg-[#1546a8] border-[#1546a8] text-slate-800 shadow-xl'
                ...
                {isSelected && (
                  <div className="absolute top-12 left-1/2 transform -translate-x-1/2 w-48 bg-white border border-[#e2e8f0] p-2.5 rounded-2xl shadow-xl z-20 flex flex-col gap-2.5 animate-fadeIn">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 bg-[#ebf3ff] hover:bg-[#1952c4] hover:text-slate-800 text-[#1952c4] font-bold text-[11px] rounded-lg transition-all border-none cursor-pointer"
                    >
                      View Details
                    </button>
                  </div>
