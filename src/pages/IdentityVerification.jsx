            ...
            {!submitted ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="w-full space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] disabled:bg-[#94a3b8] disabled:cursor-not-allowed text-slate-800 font-bold rounded-[16px] flex items-center justify-center gap-2 transition-colors text-[15px] shadow-sm ${isUploading ? 'cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    {isUploading ? (
                      <>
              ...
              <>
                ...
                <button
                  ...
                  className="w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-[16px] flex items-center justify-center gap-2 text-[15px] transition-all duration-200 shadow-sm cursor-pointer border-none"
                >
