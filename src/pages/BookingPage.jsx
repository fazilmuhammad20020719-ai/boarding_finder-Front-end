        ...
        <main className="flex-grow flex flex-col items-center justify-center max-w-2xl w-full mx-auto px-6 py-10 text-center">
          ...
          <div className="max-w-md w-full mx-auto">
            <button
              ...
              className="w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors shadow-sm cursor-pointer border-none text-[15px]"
            >
              Back to Home
            </button>
          </div>
                ...
                {step === 1 ? (
                  <>
                    ...
                    <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setStep(2); }}>
                      ...
                      {/* Submit */}
                      <div className="pt-4">
                        <button type="submit" className="w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors shadow-sm flex items-center justify-center gap-2 cursor-pointer border-none text-[15px]">
                          Continue to Payment
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors shadow-sm cursor-pointer border-none text-[15px] disabled:opacity-50"
                    >
