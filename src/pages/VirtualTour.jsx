...
const VirtualTour = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col font-sans text-slate-800 overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-800/60 text-sm flex items-center gap-2">
      ...
      <div className="relative z-10 flex-grow flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          >
            {isPlaying ? (
              <svg className="w-8 h-8 text-slate-800 ml-1" fill="currentColor" viewBox="0 0 24 24"><path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z" /></svg>
            ) : (
              <svg className="w-8 h-8 text-slate-800 ml-1" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
            )}
          </button>
      ...
      <div className="relative z-10 p-6 pb-8">
        <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
          {activeRoom.name}
          <span className="text-slate-800/50 text-sm font-normal">({TOUR_ROOMS.indexOf(activeRoom) + 1} of {TOUR_ROOMS.length})</span>
        </h3>
