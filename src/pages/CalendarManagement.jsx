            ...
            <div className="bg-white rounded-[24px] shadow-sm border border-[#e2e8f0]/60 p-6">
              ...
              <div className="flex items-center justify-between p-4 bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/70 backdrop-blur-md rounded-xl shadow-sm flex items-center justify-center p-2 shrink-0">
              ...
              <div className="flex items-center justify-between p-4 bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#FF5A5F] text-slate-800 rounded-xl shadow-sm flex items-center justify-center p-2 shrink-0 font-black">
                    A
                  </div>
                  <div>
              ...
              <div className="space-y-5">
                <div>
                  <label className="block text-[11px] font-bold text-[#475569] tracking-wider mb-2 uppercase flex items-center gap-1.5">
                    <svg className="w-3.5 h-3.5 text-slate-800" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                    Export Calendar
                  </label>
                ...
                <div>
                  ...
                  <div className="flex bg-[#f0f4f9] border border-[#e2e8f0]/40 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-[#1952c4]/20 transition-shadow">
                    ...
                    />
                    <button className="px-3 text-slate-800 font-bold text-xs bg-[#1952c4] hover:bg-[#1546a8] transition-colors">Import</button>
                  </div>
