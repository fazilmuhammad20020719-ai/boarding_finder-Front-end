    ...
    <div className="min-h-screen bg-[#f4f7f9] font-sans antialiased text-[#0f172a] pb-20">
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-8 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-[#e2e8f0]/60 overflow-hidden">
          ...
          {/* Header Summary */}
          <div className="bg-[#1952c4] p-8 text-slate-800 flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
            ...
            <div>
              <div className="text-xs font-bold text-slate-800/80 uppercase tracking-wider mb-1">Write a Review for</div>
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2">BlueSky Residences</h1>
              <p className="text-slate-800/80 font-medium">Stayed: Jan 2025 - Jun 2025 (6 Months)</p>
            </div>
          </div>
                ...
                <button 
                  ...
                  className={`px-8 py-3 font-bold rounded-xl transition-colors border-none shadow-sm flex items-center gap-2 ${
                    rating === 0 
                      ...
                      : 'bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 cursor-pointer'
                  }`}
                >
