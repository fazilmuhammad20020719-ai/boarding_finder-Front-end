    ...
    <div className="min-h-screen bg-[#f0f4f9] flex flex-col font-sans antialiased text-[#0f172a]">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-6 md:px-12 py-10">
        ...
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <Link
            to="/home"
            className="px-5 py-3 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold text-sm rounded-full transition-all shadow-sm flex items-center gap-1.5"
          >
            ← Back to Search
          </Link>
        </div>
        ...
        {savedListings.length > 0 ? (
              ...
              >
                ...
                <div className="h-52 w-full relative overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute bottom-4 left-4 z-20 flex gap-2">
                    <span className="bg-[#1952c4] text-slate-800 text-xs font-bold px-3 py-1.5 rounded-full shadow-md">
                      LKR {listing.price.toLocaleString()}/mo
                    </span>
                    <span className="bg-[#845ef7] text-slate-800 text-xs font-bold px-3 py-1.5 rounded-full shadow-md capitalize">
                      {listing.gender}
                    </span>
                  </div>
          ...
          <div className="bg-white rounded-[32px] p-16 text-center shadow-sm border border-[#e2e8f0]/60">
            ...
            <Link
              to="/home"
              className="px-8 py-3.5 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold text-sm rounded-full transition-all shadow-md inline-block"
            >
