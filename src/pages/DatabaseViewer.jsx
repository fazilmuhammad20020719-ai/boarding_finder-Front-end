      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="bg-white px-8 py-5 border-b border-[#e2e8f0] flex items-center justify-between shadow-sm z-10">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 px-5 py-2.5 rounded-xl font-bold transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed border-none cursor-pointer"
          >
