      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-6 py-12">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl shadow-sm transition-colors cursor-pointer text-sm border-none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-[#e2e8f0]/60">
          ...
          <div className="bg-[#1952c4] p-6 rounded-2xl shadow-sm border border-[#1952c4] text-slate-800 relative overflow-hidden">
            <div className="absolute -right-6 -top-6 w-24 h-24 bg-white/10 rounded-full blur-xl pointer-events-none"></div>
            <div className="text-sm font-bold text-slate-800/70 uppercase tracking-wider mb-2">Active Payment Method</div>
            ...
            <button className="mt-3 text-xs font-bold text-slate-800 hover:text-slate-800/80 transition-colors border-none bg-transparent cursor-pointer p-0">Update Method</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-[#e2e8f0]/60 overflow-hidden">
          ...
          <div className="p-5 border-t border-[#e2e8f0]/60 flex items-center justify-between text-sm">
            ...
            <div className="flex gap-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#1952c4] bg-[#1952c4] text-slate-800 font-bold cursor-pointer">1</button>
