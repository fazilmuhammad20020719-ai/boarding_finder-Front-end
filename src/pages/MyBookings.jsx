      ...
      <main className="flex-grow max-w-5xl w-full mx-auto px-6 md:px-8 py-10">
        ...
        <div className="flex overflow-x-auto hide-scrollbar gap-2 mb-8 bg-white p-2 rounded-2xl shadow-sm border border-[#e2e8f0]/60 w-fit">
          {[
            ...
            >
              {tab.label}
              <span className={`px-2 py-0.5 rounded-lg text-[10px] ${activeTab === tab.id ? 'bg-white/20 text-white' : 'bg-[#f4f7f9] text-[#94a3b8]'
                }`}>
                {tab.count}
              </span>
            </button>
                        ...
                        {booking.status === 'active' && (
                          <>
                            <button
                              ...
                              className="px-4 py-2 bg-[#10b981] hover:bg-[#059669] text-white font-bold rounded-lg transition-colors cursor-pointer text-xs"
                            >
                              View / Sign Lease
                            </button>
