            ...
            <div className="bg-white rounded-3xl p-12 text-center shadow-sm border border-[#e2e8f0]/60 flex flex-col items-center justify-center">
              ...
              {activeTab === 'upcoming' && (
                <button 
                  ...
                  className="px-6 py-2.5 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors cursor-pointer border-none text-sm shadow-sm"
                >
                  Explore Properties
                </button>
              )}
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="p-6 flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between border-t border-[#e2e8f0]/80 pt-4 mt-auto">
                      ...
                      >
                        <div className="w-8 h-8 rounded-full bg-[#e0e7ff] text-[#1952c4] flex items-center justify-center group-hover/btn:bg-[#1952c4] group-hover/btn:text-slate-800 transition-colors">
