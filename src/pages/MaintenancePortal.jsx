...
const MaintenancePortal = () => {
  ...
  const getStatusColor = (status) => {
    switch(status) {
      ...
      case 'In Progress': return 'bg-slate-100 text-blue-700';
  ...
  const getUrgencyIcon = (urgency) => {
    switch(urgency) {
      ...
      case 'Low': return <span className="text-slate-800 font-bold">!</span>;
      default: return null;
    }
  };
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          {!showForm && (
            <button 
              ...
              className="px-6 py-3 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl shadow-sm transition-all text-sm flex items-center justify-center gap-2"
            >
          ...
          <div className="bg-white rounded-[24px] shadow-sm border border-[#e2e8f0]/60 p-6 md:p-8 mb-8 animate-fade-in-down">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-[#e2e8f0]/60">
                ...
                <button 
                  type="submit"
                  className="px-6 py-2.5 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl shadow-sm transition-colors text-sm"
                >
                  Submit Ticket
                </button>
              </div>
