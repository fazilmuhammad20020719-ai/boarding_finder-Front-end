              ...
              <tr>
                ...
                {compareData.map((item) => (
                  <th key={item.id} className="p-6 border-b border-l border-[#e2e8f0]/60 w-1/4 align-top relative group">
                    ...
                    <button className="w-full py-2.5 bg-[#1952c4] hover:bg-[#1546a8] text-slate-800 font-bold rounded-xl transition-colors cursor-pointer text-sm border-none shadow-sm">
                      View Details
                    </button>
                  </th>
                ))}
