...
const TermsPrivacy = () => {
  ...
  return (
    <div className="min-h-screen bg-black font-sans antialiased text-white flex flex-col">
      ...
      {/* Hero Header */}
      <div className="bg-[#111] border-b border-[#333] py-16 text-center">
        <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight mb-4">Legal & Privacy</h1>
        <p className="text-white/50 max-w-xl mx-auto px-6">
      ...
      <main className="flex-grow max-w-5xl w-full mx-auto px-6 md:px-8 py-12 flex flex-col md:flex-row gap-12">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="md:sticky md:top-8 bg-[#1A1A1A] rounded-2xl p-6 shadow-sm border border-[#333]">
            <h3 className="text-xs font-bold text-white/40 uppercase tracking-wider mb-4">Contents</h3>
            <nav className="flex flex-col space-y-2">
              <button 
                onClick={() => scrollToSection('terms')}
                className={`text-left px-3 py-2 rounded-lg text-sm font-bold transition-colors cursor-pointer border-none ${activeSection === 'terms' ? 'bg-[#FACC15]/10 text-[#FACC15]' : 'bg-transparent text-white/60 hover:bg-[#111]'}`}
              >
                1. Terms of Service
              </button>
              <button 
                onClick={() => scrollToSection('privacy')}
                className={`text-left px-3 py-2 rounded-lg text-sm font-bold transition-colors cursor-pointer border-none ${activeSection === 'privacy' ? 'bg-[#FACC15]/10 text-[#FACC15]' : 'bg-transparent text-white/60 hover:bg-[#111]'}`}
              >
                2. Privacy Policy
              </button>
              <button 
                onClick={() => scrollToSection('refunds')}
                className={`text-left px-3 py-2 rounded-lg text-sm font-bold transition-colors cursor-pointer border-none ${activeSection === 'refunds' ? 'bg-[#FACC15]/10 text-[#FACC15]' : 'bg-transparent text-white/60 hover:bg-[#111]'}`}
              >
                3. Refund Policy
              </button>
              <button 
                onClick={() => scrollToSection('data')}
                className={`text-left px-3 py-2 rounded-lg text-sm font-bold transition-colors cursor-pointer border-none ${activeSection === 'data' ? 'bg-[#FACC15]/10 text-[#FACC15]' : 'bg-transparent text-white/60 hover:bg-[#111]'}`}
              >
        ...
        {/* Content Area */}
        <div className="flex-grow bg-[#1A1A1A] rounded-3xl p-8 md:p-12 shadow-sm border border-[#333] prose prose-invert max-w-none">
          
          <section id="terms" className="mb-16 scroll-mt-8">
            <h2 className="text-2xl font-extrabold text-white mb-6 pb-4 border-b border-[#333]">1. Terms of Service</h2>
            ...
            <h4 className="text-lg font-bold text-white mt-6 mb-3">1.1 User Responsibilities</h4>
            ...
            <h4 className="text-lg font-bold text-white mt-6 mb-3">1.2 Prohibited Activities</h4>
          ...
          <section id="privacy" className="mb-16 scroll-mt-8">
            <h2 className="text-2xl font-extrabold text-white mb-6 pb-4 border-b border-[#333]">2. Privacy Policy</h2>
            <p className="text-white/70 leading-relaxed mb-4">
              Your privacy is critically important to us. This policy outlines how we collect, use, and protect your personal information.
            </p>
            <h4 className="text-lg font-bold text-white mt-6 mb-3">2.1 Information We Collect</h4>
            <p className="text-white/70 leading-relaxed mb-4">
            ...
            <h4 className="text-lg font-bold text-white mt-6 mb-3">2.2 How We Use Your Information</h4>
            <p className="text-white/70 leading-relaxed">
          ...
          <section id="refunds" className="mb-16 scroll-mt-8">
            <h2 className="text-2xl font-extrabold text-white mb-6 pb-4 border-b border-[#333]">3. Refund Policy</h2>
            <p className="text-white/70 leading-relaxed mb-4">
            ...
            <div className="bg-[#111] p-6 rounded-2xl border border-[#333] mb-6">
              <h4 className="font-bold text-white mb-2">Standard Cancellation Timeline</h4>
              <ul className="space-y-3 text-sm text-white/70">
                ...
                <li className="flex justify-between border-b border-[#333] pb-2">
                  ...
                  <span className="font-bold text-white">Full Deposit Refund (minus fees)</span>
                </li>
          ...
          <section id="data" className="scroll-mt-8">
            <h2 className="text-2xl font-extrabold text-white mb-6 pb-4 border-b border-[#333]">4. User Data & Deletion</h2>
            <p className="text-white/70 leading-relaxed mb-4">
            ...
            <div className="mt-8 p-6 bg-[#FACC15]/5 rounded-2xl border border-[#FACC15]/20 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <h4 className="font-bold text-[#FACC15]">Need to contact our legal team?</h4>
                <p className="text-sm text-[#FACC15]/80 mt-1">For specific privacy concerns, reach out to us directly.</p>
              </div>
              <button className="px-6 py-2.5 bg-[#FACC15] text-black font-bold rounded-xl shadow-sm border-none cursor-pointer hover:bg-[#EAB308] transition-colors whitespace-nowrap">
                Email Legal Team
              </button>
            </div>
          </section>
