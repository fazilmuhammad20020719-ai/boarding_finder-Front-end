            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={!reason}
                  className="w-2/3 py-3 bg-red-600 hover:bg-red-700 disabled:bg-red-300 disabled:cursor-not-allowed text-slate-800 font-bold rounded-[12px] transition-colors text-sm shadow-sm"
                >
                  Submit Report
                </button>
              </div>
